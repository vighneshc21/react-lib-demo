...
function cr() {
  if (Oe) return F;
  Oe = 1;
  var w = we, P = Symbol.for("react.element"), N = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, I = w.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, W = { key: !0, ref: !0, __self: !0, __source: !0 };
  function j(h, c, T) {
    var p, b = {}, R = null, $ = null;
    T !== void 0 && (R = "" + T), c.key !== void 0 && (R = "" + c.key), c.ref !== void 0 && ($ = c.ref);
    for (p in c) m.call(c, p) && !W.hasOwnProperty(p) && (b[p] = c[p]);
    if (h && h.defaultProps) for (p in c = h.defaultProps, c) b[p] === void 0 && (b[p] = c[p]);
    return { $$typeof: P, type: h, key: R, ref: $, props: b, _owner: I.current };
  }
...
function dr() {
  return Se || (Se = 1, process.env.NODE_ENV !== "production" && function() {
    var w = we, P = Symbol.for("react.element"), N = Symbol.for("react.portal"), m = Symbol.for("react.fragment"), I = Symbol.for("react.strict_mode"), W = Symbol.for("react.profiler"), j = Symbol.for("react.provider"), h = Symbol.for("react.context"), c = Symbol.for("react.forward_ref"), T = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), b = Symbol.for("react.memo"), R = Symbol.for("react.lazy"), $ = Symbol.for("react.offscreen"), Q = Symbol.iterator, Pe = "@@iterator";
    function je(e) {
    ...
    function We(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === m || e === W || Ie || e === I || e === T || e === p || Ae || e === $ || ke || De || Fe || typeof e == "object" && e !== null && (e.$$typeof === R || e.$$typeof === b || e.$$typeof === j || e.$$typeof === h || e.$$typeof === c || // This needs to include all possible module reference object
    ...
    var E = Object.assign, x = 0, te, ne, ae, ie, oe, ue, se;
    function le() {
    }
    ...
    function Te(e, r, t, n, o, u) {
      {
        ...
        if (!i) {
          ...
          d ? a += d : a += he();
          var s;
          e === null ? s = "null" : K(e) ? s = "array" : e !== void 0 && e.$$typeof === P ? (s = "<" + (y(e.type) || "Unknown") + " />", a = " Did you accidentally export a JSX literal instead of a component?") : s = typeof e, f("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", s, a);
        }
        var l = er(e, r, t, o, u);
        if (l == null)
          return l;
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, Z, _, lr, _), me[_ + Z] = !0;
          }
        }
...
var Ce;
function vr() {
  return Ce || (Ce = 1, process.env.NODE_ENV === "production" ? U.exports = cr() : U.exports = dr()), U.exports;
}
var pr = vr();
const yr = ({ text: w }) => /* @__PURE__ */ pr.jsx("div", { style: { padding: "10px", backgroundColor: "lightblue" }, children: w });
export {
  yr as MyComponent
};
